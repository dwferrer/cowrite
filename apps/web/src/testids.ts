...
export const testids = {
  ...
  streamingRetrying: 'streaming-retrying',
  streamingUsage: 'streaming-usage',
  streamingCancel: 'streaming-cancel',
  keepPartial: 'keep-partial',
  keepPartialApply: 'keep-partial-apply',
  keepPartialDiscard: 'keep-partial-discard',
  ...
  frontierInstructInput: 'frontier-instruct-input',
  frontierInstructSubmit: 'frontier-instruct-submit',
  ...
  quickEditSubmit: 'quick-edit-submit',
  snippetRewriting: 'snippet-rewriting',
  snippetRunLink: 'snippet-run-link',

  // provenance viewer (04 §7.4)
  runViewer: 'run-viewer',
  runViewerHeader: 'run-viewer-header',
  runViewerClose: 'run-viewer-close',
  runPromptToggle: 'run-prompt-toggle',
  runRegion: 'run-region',
  runPromptText: 'run-prompt-text',
  runPromptMessage: 'run-prompt-message',
  runToolCall: 'run-tool-call',
  ...
  // illustration (08 §8, 04 §10, Stage 5)
  illustrationShimmer: 'illustration-shimmer',
  illustrationCaption: 'illustration-caption',
  illustrationBadge: 'illustration-badge',
  illustrationRetry: 'illustration-retry',
  illustrationSettingsLink: 'illustration-settings-link',
  illustrationImage: 'illustration-image',
  illustrationPlaceholder: 'illustration-placeholder',
  sectionMenuButton: 'section-menu-button',
  sectionMenu: 'section-menu',
  illustrateAction: 'illustrate-action',
  regenerateAction: 'regenerate-action',
  removeIllustrationAction: 'remove-illustration-action',
  regenerateGuidanceBox: 'regenerate-guidance-box',
  regenerateGuidanceInput: 'regenerate-guidance-input',
  regenerateGuidanceSubmit: 'regenerate-guidance-submit',
  regenerateGuidanceCancel: 'regenerate-guidance-cancel',
  illustrationLightbox: 'illustration-lightbox',
  illustrationLightboxClose: 'illustration-lightbox-close',
  illustrationLightboxRegenerate: 'illustration-lightbox-regenerate',
  illustrationRunLink: 'illustration-run-link',
  worldImageGenerate: 'world-image-generate',
  worldImageGuidanceInput: 'world-image-guidance-input',
  worldImageGuidanceSubmit: 'world-image-guidance-submit',
  worldImageGuidanceCancel: 'world-image-guidance-cancel',
  runIllustrationSection: 'run-illustration-section',
  runIllustrationPrompt: 'run-illustration-prompt',
  runIllustrationCritique: 'run-illustration-critique',
  runIllustrationArtifactImage: 'run-illustration-artifact-image',
  settingsComfyHealth: 'settings-comfy-health',
  settingsComfyWorkflowRow: 'settings-comfy-workflow-row',
  settingsComfyMarkerHelp: 'settings-comfy-marker-help',
